export const GAME_NAME = 'Reino de Eldoria';
...
export const GAME_LORE =
  'Comece como um campones reunindo Fragmentos de Eter e transforme sua vila em um reino mistico capaz de dobrar a magia antiga.';
